...
/**
 * Thrown when a transfer has already been fulfilled, and cannot be rejected or otherwise mutated.
 */
public class TransferAlreadyFulfilledException extends LedgerPluginException {
   ...
   */
  public TransferAlreadyFulfilledException(InterledgerAddress sourceLedgerPrefix,
   ...
   */
  public TransferAlreadyFulfilledException(String message, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId) {
   ...
   * @since 1.4
   */
  public TransferAlreadyFulfilledException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public TransferAlreadyFulfilledException(Throwable cause, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId) {
