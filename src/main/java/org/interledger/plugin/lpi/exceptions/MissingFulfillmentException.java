...
/**
 * A transfer has not yet been fulfilled, so the fulfillment cannot be fetched.
 *
 * @deprecated This exception will likely be removed in a future release because {@link
 *     LedgerPlugin#getFulfillment(TransferId)} returns an {@link java.util.Optional} instead.
 */
@Deprecated
public class MissingFulfillmentException extends LedgerPluginException {
   ...
   */
  public MissingFulfillmentException(InterledgerAddress sourceLedgerPrefix,
   ...
   */
  public MissingFulfillmentException(String message, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId) {
   ...
   * @since 1.4
   */
  public MissingFulfillmentException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public MissingFulfillmentException(Throwable cause, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId) {
   ...
   * @since 1.7
   */
  public MissingFulfillmentException(String message, Throwable cause, boolean enableSuppression,
