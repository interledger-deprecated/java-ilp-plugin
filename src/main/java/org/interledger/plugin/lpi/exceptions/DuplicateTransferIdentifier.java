...
/**
 * A transfer with the same ID but different data/fields has already been sent and accepted by the
 * underlying ledger.
 */
public class DuplicateTransferIdentifier extends LedgerPluginException {
   ...
   */
  public DuplicateTransferIdentifier(InterledgerAddress sourceLedgerPrefix,
   ...
   */
  public DuplicateTransferIdentifier(String message, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId) {
   ...
   * @since 1.4
   */
  public DuplicateTransferIdentifier(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public DuplicateTransferIdentifier(Throwable cause, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId) {
   ...
   * @since 1.7
   */
  public DuplicateTransferIdentifier(String message, Throwable cause, boolean enableSuppression,
