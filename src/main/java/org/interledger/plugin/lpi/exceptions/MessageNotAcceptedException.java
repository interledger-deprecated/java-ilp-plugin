...
/**
 * Thrown if a message is rejected due to ledger-side business logic.
 */
public class MessageNotAcceptedException extends LedgerPluginException {
   ...
   */
  public MessageNotAcceptedException(InterledgerAddress sourceLedgerPrefix,
      MessageId messageId) {
   ...
   */
  public MessageNotAcceptedException(String message, InterledgerAddress sourceLedgerPrefix,
      MessageId messageId) {
   ...
   * @since 1.4
   */
  public MessageNotAcceptedException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public MessageNotAcceptedException(Throwable cause, InterledgerAddress sourceLedgerPrefix,
      MessageId messageId) {
   ...
   * @since 1.7
   */
  public MessageNotAcceptedException(String message, Throwable cause, boolean enableSuppression,
