...
/**
 * Thrown if a transfer is rejected due to ledger-side business logic. This is distint from {@link
 * TransferNotAcceptedException}, which is meant to indicate that something was invalid about the
 * Transfer itself.
 */
public class TransferNotAcceptedException extends LedgerPluginException {
   ...
   */
  public TransferNotAcceptedException(InterledgerAddress sourceLedgerPrefix, TransferId transferId,
   ...
   */
  public TransferNotAcceptedException(String message, InterledgerAddress sourceLedgerPrefix,
   ...
   * @since 1.4
   */
  public TransferNotAcceptedException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public TransferNotAcceptedException(Throwable cause, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId, InterledgerProtocolError rejectionReason) {
   ...
   * @since 1.7
   */
  public TransferNotAcceptedException(String message, Throwable cause, boolean enableSuppression,
