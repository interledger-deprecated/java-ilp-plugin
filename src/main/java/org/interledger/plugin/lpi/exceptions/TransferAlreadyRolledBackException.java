...
/**
 * Thrown when a transfer has already been rolled back, and cannot be fulfilled or otherwise
 * mutated.
 */
public class TransferAlreadyRolledBackException extends LedgerPluginException {
   ...
   */
  public TransferAlreadyRolledBackException(InterledgerAddress sourceLedgerPrefix,
   ...
   */
  public TransferAlreadyRolledBackException(String message, InterledgerAddress sourceLedgerPrefix,
      TransferId transferId) {
   ...
   * @since 1.4
   */
  public TransferAlreadyRolledBackException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public TransferAlreadyRolledBackException(Throwable cause,
      InterledgerAddress sourceLedgerPrefix, TransferId transferId) {
